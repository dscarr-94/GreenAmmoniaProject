...
5. A prompt will appear telling you to Select a file for Streams. Press OK and select the desire file.
   ...
   Note: As of this version, only the "AspenStreams03122020.xlsx" has been tested.

6. Enter a name for the worksheet. ("Aspen Data Tables Modified" in the procedures). Press OK.

7. Enter a name for the next worksheet. ("Overall" in the procedures). Press OK. 
...
Note: This only completes up to step 11. Step 12 is in progress.

9. A "DONE!" prompt should appear indicating it finished sucessfully.
